    ...
    <footer className="bg-gray-800 text-white mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm">
              ...
              Una plataforma comunitaria dedicada al bienestar de nuestras mascotas.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/report" className="text-gray-300 hover:text-primary-400 transition-colors">
                  Reportar Mascota
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-400">
          <p>&copy; {currentYear} PetFinder. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
